  ...
  },
  {
    ...
    content: {
      ...
      challenge: {
        ...
        en: "Online ticket sales concentrate payment volume in minutes and operate with limited inventory. Every antifraud rejection is a lost sale that doesn't come back.",
      },
      solution: {
        es: "T1pagos opera como capa de procesamiento y control de fraude sobre las transacciones con tarjeta de Ticketopolis. Su configuración antifraude está afinada al ticketing: distingue al comprador legítimo del bot que acapara inventario, y aprueba sin fricción. Es la diferencia entre un checkout que abre y cierra una venta en minutos, y uno que se atasca antes de que se agote el inventario.",
